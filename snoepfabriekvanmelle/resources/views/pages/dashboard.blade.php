    ...
    <div class="flex justify-between mt-6 gap-4">
        <div class="w-[30rem] h-36 rounded-xl pt-6 bg-blue text-white">
            <div class="flex justify-between mx-auto max-w-[85%]">
                ...
                <div class="flex justify-center items-center w-20 h-8 rounded-full mt-auto space-x-2 border border-white">
        ...
        <div class="w-[30rem] h-36 rounded-xl pt-6 border border-gray-300">
            <div class="flex justify-between mx-auto max-w-[85%]">
                ...
                <div class="flex justify-center items-center w-20 h-8 rounded-full mt-auto space-x-2 border border-black">
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            <td class="w-4 p-4">
                                <div class="flex space-x-4">
                                    ...
                                    <form action="/storingen/{{ $storing->id }}" method="POST">
                                        @csrf
                                        @method('PATCH')
